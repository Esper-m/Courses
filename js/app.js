(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const deadline = new Date("2022", "01", "11", "1", "2");
        let timerId = null;
        ...
        const $days = document.querySelector(".discont-timer__days");
        const $hours = document.querySelector(".discont-timer__hours");
        const $minutes = document.querySelector(".discont-timer__minutes");
        const $seconds = document.querySelector(".discont-timer__seconds");
        countdownTimer();
    ...
    function initSliders() {
        if (document.querySelector(".team-page__slider")) new core(".team-page__slider", {
            ...
            loopedSlides: 4,
            navigation: {
                prevEl: ".controls-team__prev",
                nextEl: ".controls-team__next"
            },
            on: {}
        });
        if (document.querySelector(".testimonials-page__slider")) new core(".testimonials-page__slider", {
            ...
            navigation: {
                prevEl: ".controls-testimonials__prev",
                nextEl: ".controls-testimonials__next"
            },
            on: {}
        });
        if (document.querySelector(".other-slider__slider")) new core(".other-slider__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            speed: 800,
            navigation: {
                prevEl: ".controls-other__prev",
                nextEl: ".controls-other__next"
            },
            on: {}
        });
    }
